package com.trials.tests;

import com.aventstack.extentreports.ExtentReports;
import com.aventstack.extentreports.ExtentTest;
import com.aventstack.extentreports.reporter.ExtentHtmlReporter;
import com.trials.utilities.BrowserUtils;
...
// create a report path once
        String projectPath = System.getProperty("user.dir");
        String path = projectPath + "/test-output/report.html";

/*  String projectPath = System.getProperty("user.dir");  //will report everytime
...
// extentLogger.fail(result.getName());
 ...
 // take the screenshot and return the path of screenshot
